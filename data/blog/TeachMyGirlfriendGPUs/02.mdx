...
This is the second episode of God’s-eye View of the GPU.Last time, we introduced a basic GPU and what kind of pipeline it should have.As time moved on, new demands arose.So now let’s look at how to evolve from a simple unified pipeline into a more flexible and comprehensive one.
